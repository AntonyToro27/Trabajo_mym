        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTW1aORTs-KhsZpw1QxnQWK7rAhtREhU6-oRl4E6-ld2El7gqomcubWuEQDIX1FAOcTYJwmreC_b94ofDuPhaKdhQ4TFjLJT3ttYW9bTqcCRay9A65KaXYedQ&usqp=CAc" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Zapatos Negros Deportivos</h5>
                        <h6 class="card-subtitle text-muted mb-2">$50.000</h6>
                        <p class="card-text">Zapatos Negros deportivos sin cordones.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://img.ltwebstatic.com/images3_spmp/2023/11/13/2d/1699845160ca6a73fc9cde4e4b8b9852a7fc62af3c_thumbnail_560x.webp" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Zapatos Negros Planos</h5>
                        <h6 class="card-subtitle text-muted mb-2">$60.000</h6>
                        <p class="card-text">Zapatos Negros Planos</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://bosico.vtexassets.com/arquivos/ids/2096019-1200-auto?v=638697957546170000&width=1200&height=auto&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Botas Tisot</h5>
                        <h6 class="card-subtitle text-muted mb-2">$60.000</h6>
                        <p class="card-text">Botas Tisot.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://bosico.vtexassets.com/arquivos/ids/2007746-1200-auto?v=638513193651800000&width=1200&height=auto&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Zapatos Lowell</h5>
                        <h6 class="card-subtitle text-muted mb-2">$90.000</h6>
                        <p class="card-text">Zapatos Lowell.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://bosico.vtexassets.com/arquivos/ids/2006042-1200-auto?v=638510676715370000&width=1200&height=auto&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Zapatos con Luces</h5>
                        <h6 class="card-subtitle text-muted mb-2">$120.000</h6>
                        <p class="card-text">Zapatos con Luces.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
