        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcRkppI6nE36jotyCwEX3mTA7oj484OFUb1pbNcacLRc91-5qu-W6YSkFW734_Lmh_mOZDAIO8ucQXQvZ5_7rVsf1IridcCypOIIesBBlY7fimfhuvRQw4ry69xXydXf1VpYQa-9i-I&usqp=CAc" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantalonetas Casuales</h5>
                        <h6 class="card-subtitle text-muted mb-2">$80.000</h6>
                        <p class="card-text">Pantalonetas Casuales.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSE2m1XBtNYsNXzqGnVc47e7BNDUpY7JX0yNokgvvbuHzOAVvhs1l7ip-touBwueUNpm9pY5jk8IWSjEd5HKOBo_mvGlhKj4y7RilLUbjW486hLirATgMb41w&usqp=CAc" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantalonetas Playeras</h5>
                        <h6 class="card-subtitle text-muted mb-2">$50.000</h6>
                        <p class="card-text">Pantalonetas Playeras</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQyySmD8ivGrJuBIsZY-332ETEvgFj4yBXx_7UJ0mzfPyXlwaDX3x9-QhFbYfp8fLVvT--wSJPnmGiXxzMBDpVwvmNTT43FeFS9e9zyFWSxY3Z4mjSOUBLfiQgth9pwiF5Ywze33F4&usqp=CAc" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantaloneta Estampado Graffity</h5>
                        <h6 class="card-subtitle text-muted mb-2">$50.000</h6>
                        <p class="card-text">Pantaloneta Estampado Graffity.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRTMom5aPfu8QrbZvfViL33Beswwbdjrl2bZoBTHGQFMcUa8NHQrGm9cHZWx2GMl8j2IDw9vKwb_mcW9mXAReqPeeBvv1T7Ji6440twoWlwiJ3RvpKjMVwWlA" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantaloneta Star Wars</h5>
                        <h6 class="card-subtitle text-muted mb-2">$40.000</h6>
                        <p class="card-text">Pantaloneta Star Wars.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSRHpv2qBznELF58AvBoMjtB7Ac2ZsnymML17Mv3k0SDc6lueb6cjr88_dl9fKw8VUdl5j9N3f5llxo6ieqpxk7UU2jWeZ1Yt_PpBWCL6KG5Kddand5VH9I1A" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantaloneta Spider Man</h5>
                        <h6 class="card-subtitle text-muted mb-2">$39.000</h6>
                        <p class="card-text">Pantaloneta Spider Man.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
