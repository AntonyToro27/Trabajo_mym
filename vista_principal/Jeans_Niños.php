        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://i.pinimg.com/736x/d4/8b/99/d48b99aefe59dbeea7a9985b967cc09e.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantalon Casual</h5>
                        <h6 class="card-subtitle text-muted mb-2">$80.000</h6>
                        <p class="card-text">Pantalon Casual.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4239014-600-900?v=638743712478730000&width=600&height=900&aspect=true" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantalon en Denim</h5>
                        <h6 class="card-subtitle text-muted mb-2">45.000</h6>
                        <p class="card-text">Pantalon en Denim</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4089220-600-900?v=638661298843770000&width=600&height=900&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantalon Soft Slim fit</h5>
                        <h6 class="card-subtitle text-muted mb-2">$67.000</h6>
                        <p class="card-text">Pantalon Soft Slim fit.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4063800-600-900?v=638652679455830000&width=600&height=900&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantalon Cargo</h5>
                        <h6 class="card-subtitle text-muted mb-2">$50.000</h6>
                        <p class="card-text">Pantalon Cargo.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4389805-600-900?v=638785727323570000&width=600&height=900&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Pantalon en Sarga cafe</h5>
                        <h6 class="card-subtitle text-muted mb-2">$35.000</h6>
                        <p class="card-text">Pantalon en Sarga cafe.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
