        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/bd0be168771c4d0394689bb5d2e3ab62_9366/Conjunto_camiseta_y_pantalon_corto_adidas_x_Disney_Mickey_Mouse_Bebe_Blanco_JF3625_01_laydown.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto camiseta y pantalón corto Disney</h5>
                        <h6 class="card-subtitle text-muted mb-2">$95.000</h6>
                        <p class="card-text">Conjunto camiseta y pantalón corto Disney.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/165944baf211437b820159c075d1efe8_9366/Conjunto_de_Shorts_y_Camiseta_adidas_x_Disney_Minnie_Mouse_Ninos_Negro_JD0575_01_laydown.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto de Shorts y Camiseta Disney</h5>
                        <h6 class="card-subtitle text-muted mb-2">$85.000</h6>
                        <p class="card-text">Conjunto de Shorts y Camiseta Disney.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/c4126473562944f5874f6632d86e3431_9366/Conjunto_adidas_Disney_Lilo_and_Stitch_Jogger_Ninos_Morado_JD4561_25_model_hover.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto adidas Disney Lilo & Stitch</h5>
                        <h6 class="card-subtitle text-muted mb-2">$150.000</h6>
                        <p class="card-text">Conjunto adidas Disney Lilo & Stitch.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/d891688d397b4ddda4a5822cad62d838_9366/Conjunto_Camiseta_y_Shorts_adidas_Originals_x_Minecraft_Rosa_JZ9943_25_model.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Camiseta y Shorts adidas Minecraft</h5>
                        <h6 class="card-subtitle text-muted mb-2">$99.000</h6>
                        <p class="card-text">Conjunto Camiseta y Shorts adidas Minecraft.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/97f005fd259a43ab81d23c2726d5eba5_9366/Conjunto_Adicolor_Shorts_y_Camiseta_Ninos_Rojo_JC9156_25_model.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Adicolor Shorts y Camiseta</h5>
                        <h6 class="card-subtitle text-muted mb-2">$165.000</h6>
                        <p class="card-text">Conjunto Adicolor Shorts y Camiseta.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
