        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcQQOQPXeT-Emw8BxHk6_bHYMYHjLCi5zu4ZwWo7wN35PeJOtgUaKZUpreXzNlN_PlAAJ60oq8FNJZNnkkh4ZcDyvETidWv0AVCfzVQFNaXGACEWQ8nrdFS0" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Lilo & Stich</h5>
                        <h6 class="card-subtitle text-muted mb-2">$50.000</h6>
                        <p class="card-text">VCamiseta Lilo & Stich.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSqc3HWYg0BhGt8R94EOaPoo_nkqoUZt6xqn43jagqUDUds47GWYEt8B31OPBOjvDejYvRsoaCvmnLDtiH8SmCPvmzi7YluIoItnwDz6BKfMwb7bavqxYT8VO0" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Lila Pastel</h5>
                        <h6 class="card-subtitle text-muted mb-2">$45.000</h6>
                        <p class="card-text">Camiseta Lila Pastel.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcTjXnSsdkxncDF_jaBcvEvV2DRKIvxPIqj7pl0Jb7yGJ8v6r1I6jcmcKXe8thO1IlHhM_MJKH6PKgviZXl-KUXMGPj3zOXtqMfZDTvFuPqnleRxJD0wP1NSJA" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta De Minni Mouse</h5>
                        <h6 class="card-subtitle text-muted mb-2">$45.000</h6>
                        <p class="card-text">Camiseta De Minni Mouse.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQ0nTYXtG1HFt06lQ_mhahRd3jZnb4QfWJ3lmNtcFNMSDH0pel4A6oiROPGZnVNwFO0BjMH0TfTYzeYY60hEaWdoDldDdyGDSqtyiIuP6Fr7YKNtdtWfgUI" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Estamapado Princesa Jasmin</h5>
                        <h6 class="card-subtitle text-muted mb-2">$50.000</h6>
                        <p class="card-text">Camiseta Estamapado Princesa Jasmin.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSanU0xjMWNJNosbinoolF-0FUQ-CCCo0dCVXeGHmtR5Mf0XZrAo644ReNlrpw2UNZlO5H_5wG9NmQ6p5N8nByHXo1R4fWSLXgDXHt7nU2GZkzHLRmoN6UP4A" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta De Snoopy</h5>
                        <h6 class="card-subtitle text-muted mb-2">$50.000</h6>
                        <p class="card-text">Camiseta De Snoopy.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
