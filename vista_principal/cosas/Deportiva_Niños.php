        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://offcorss.vtexassets.com/arquivos/ids/861288-1200-auto?v=638584646965970000&width=1200&height=auto&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Gris</h5>
                        <h6 class="card-subtitle text-muted mb-2">$100.000</h6>
                        <p class="card-text">Conjunto Deportivo Gris.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4405324-483-725?v=638789170721570000&width=483&height=725&aspect=true" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/3939579/Camiseta-esqueleto-de-deporte-en-DryMove%E2%84%A2---Verde---H-M-CO.jpg?v=638606020593970000" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Basquetball</h5>
                        <h6 class="card-subtitle text-muted mb-2">$70.000</h6>
                        <p class="card-text">Conjunto Deportivo Basquetball.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4338212-483-725?v=638769300432870000&width=483&height=725&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo DryMove</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Conjunto Deportivo DryMove.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4367628-483-725?v=638779670138500000&width=483&height=725&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Basquetball</h5>
