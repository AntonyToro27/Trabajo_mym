        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/0f8f0d1dbc744f7f8fa5ccb9f04d19af_9366/Camiseta_Estampada_Ninos_Blanco_IZ0419_01_laydown_hover.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Blanca Estampada</h5>
                        <h6 class="card-subtitle text-muted mb-2">$80.000</h6>
                        <p class="card-text">Camiseta Blanca Estampada Adidas.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/437bb2240d62420ea42cefe4f8175ab7_9366/Camiseta_adidas_Originals_x_Minecraft_Estampada_Gris_JZ9937_01_laydown.jpg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Adidas Estampada Mineccraft</h5>
                        <h6 class="card-subtitle text-muted mb-2">$150.000</h6>
                        <p class="card-text">Camiseta Adidas Estampada Mineccraft</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4360440-600-900?v=638776215807500000&width=600&height=900&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Beige Con estampado de Bluey</h5>
                        <h6 class="card-subtitle text-muted mb-2">$230.000</h6>
                        <p class="card-text">Camiseta Beige Con estampado de Bluey.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4350263-600-900?v=638774914051130000&width=600&height=900&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Azul Tipo Polo</h5>
                        <h6 class="card-subtitle text-muted mb-2">$599.000</h6>
                        <p class="card-text">Camiseta Azul Tipo Polo en Pique de Algodon.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4273617-600-900?v=638749706845470000&width=600&height=900&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Camiseta Azul en Algodon con Estampado de Jerry</h5>
                        <h6 class="card-subtitle text-muted mb-2">$999.000</h6>
                        <p class="card-text">Camiseta Azul en Algodon con Estampado de Jerry.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
