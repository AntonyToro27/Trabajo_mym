        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://papos.shop/cdn/shop/products/botas-arco-iris-416493.jpg?v=1743544407" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Botas Arco Iris</h5>
                        <h6 class="card-subtitle text-muted mb-2">$125.000</h6>
                        <p class="card-text">Botas Arco Iris.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://papos.shop/cdn/shop/files/Photoroom_20250129_165429.png?v=1743545395" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Tenis Desert Dune</h5>
                        <h6 class="card-subtitle text-muted mb-2">$100.000</h6>
                        <p class="card-text">Tenis Desert Dune.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://papos.shop/cdn/shop/files/Photoroom_20240914_031132.png?v=1743544908" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Botas Niñas Luz de Luna Negras</h5>
                        <h6 class="card-subtitle text-muted mb-2">$150.000</h6>
                        <p class="card-text">Botas Niñas Luz de Luna Negras.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://papos.shop/cdn/shop/files/DulceEncanto_4cf3d720-936e-4d41-94fe-5a7f977b2cad.jpg?v=1743545116" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Zapatos Casuales Dulce Encanto</h5>
                        <h6 class="card-subtitle text-muted mb-2">$99.000</h6>
                        <p class="card-text">Zapatos Casuales Dulce Encanto.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://papos.shop/cdn/shop/products/terrena-palo-de-rosa-1.webp?v=1743544032" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Zapatos Terrena Palo de Rosa</h5>
                        <h6 class="card-subtitle text-muted mb-2">$85.000</h6>
                        <p class="card-text">Zapatos Terrena Palo de Rosa.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
