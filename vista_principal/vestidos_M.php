        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4422530-483-725?v=638798719445000000&width=483&height=725&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Vestido Lencero Drapeado</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Vestido corto en punto suave con escote cuadrado y tiras delgadas.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4404347-483-725?v=638788327805670000&width=483&height=725&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Vestido Ajustado con Diseño Drapeado</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Vestido corto manga sisa en punto arrugado.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4150003-483-725?v=638685531242800000&width=483&height=725&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Vestido Denim con Cuello camisero</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Vestido corto en denim de algodón rígido.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4490009-483-725?v=638824619234700000&width=483&height=725&aspect=true" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Vestido Halter Efecto Crochet</h5>
                        <h6 class="card-subtitle text-muted mb-2">$99.000</h6>
                        <p class="card-text">Vestido hasta la pantorrilla ajustado en tejido efecto crochet de mezcla de algodón.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://hmcolombia.vtexassets.com/arquivos/ids/4391428/Vestido-camisero-con-cinturon-de-anudar---Blanco-Estampado-azul---H-M-CO.jpg?v=638786784002770000" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Vestido Camisero con cinturón de anudar</h5>
                        <h6 class="card-subtitle text-muted mb-2">$85.000</h6>
                        <p class="card-text">Vestido a la pantorrilla con cuello camisero, cierre delantero con botones y mangas raglán cortas.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
