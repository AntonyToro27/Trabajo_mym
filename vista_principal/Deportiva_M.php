        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="img/Mujeres/Conjunto_deportivo_marron5.jpeg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Marron</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Conjunto Deportivo Marron.</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="img/Mujeres/Conjunto_deportivo_negro6.jpeg" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Negro</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Conjunto Deportivo Negro.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcQk7ZskxtsUTq2hgtpOlXY2wQf4HV8RE4Ha_MNdskGzYGImb1GghHpprpAOy5Ze56CA7MKNtgq98RrZqETOcnsz-1Q6R-tL4NpIriToPlzMVEYgUMJR9CihcFfz6-fxPsNeimNE&usqp=CAc" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Azul</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Conjunto Deportivos Azul.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSHmJIyRJ5yFHwBZ-yevLT5febGv_f9S2Nfgo8SlbfMvz_koXb07NcQ6U0iUjIee5gjCwV1lc9lZdGf1nqlic57IhjidZi9HqBTtS6jdQ7sRZLekicZvFDyVV1Tel2CVjPWswtFtR4&usqp=CAc" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Color Bruma</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Conjunto Deportivos Color Bruma.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 shadow-sm d-flex flex-column">
                        <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQMIYKvHfpLsrMj4BUvvKFEdMuaLrrldSIje-FSnc85I2Uh-VXOtcebnOsbggunomphFTAP1_n9Tzp9zsr5ThYEzLQTmTJQYNbZ6NlHHXVjiBCWHHFyGAmXyQ&usqp=CAc" class="card-img-top img-fluid" alt="Producto B" style="height: 400px;">
                    <div class="card-body flex-grow-1">
                        <h5 class="card-title">Conjunto Deportivo Purpura</h5>
                        <h6 class="card-subtitle text-muted mb-2">$75.000</h6>
                        <p class="card-text">Conjunto Deportivo Purpura.</p>
                    </div>
                    <div class="card-footer bg-white border-0 d-flex justify-content-between">
                        <a href="#" class="btn btn-outline-primary btn-sm">Ver más</a>
                        <?php if (isset($_SESSION['usuario'])): ?>
